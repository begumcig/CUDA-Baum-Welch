...
//Given the transition (A), prior (pi) and emission (B) probabilities, we are calculating the likelihood of the observence sequence P(O | A,B,pi)
//The observence sequence is of length L. There are N hidden states.
//alpha[i, t] is the possibility of being in hidden state i at time t with the observence sequence O_1.....O_t, given model parameters.
